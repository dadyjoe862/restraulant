...
export interface InputFieldResolver {
    check: (type: g.GraphQLInputType, field: g.GraphQLArgument | g.GraphQLInputField) => boolean;
    getSchema: (type: g.GraphQLInputType) => BaseSchema;
    Component?: React.ElementType<Obj & {
        value: any;
        onChange: (i: any) => any;
    }>;
}
export interface FieldResolver {
    check: (type: g.GraphQLObjectType, field: g.GraphQLField<any, any>) => boolean;
